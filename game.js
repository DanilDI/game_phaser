...
function enemyCreator(type,x,y,scene){
    ...
    if(type==2) var concreteEnemy= scene.physics.add.sprite(x, y, 'ghost').setData({animation:'ghost_idle', hp: 40, music: '180_ADNDDANDDA', speed:300, pattern: [28,210,365,540,710,855,1030,1190,1370,1530],satrnumber: 10,pause:2000 ,attacks: [0,1,2,1,1,0,2,1,1,0]});
